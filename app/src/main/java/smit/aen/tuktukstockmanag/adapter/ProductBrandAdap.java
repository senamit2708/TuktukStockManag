...
public class ProductBrandAdap extends RecyclerView.Adapter<ProductBrandAdap.ViewHolder> {

    private static final String TAG = ProductBrandAdap.class.getSimpleName();
    private Context context;
    private TopicIFace mInterface;
    private List<String> typeList;

    public ProductBrandAdap(Context context, TopicIFace mInterface) {
